...
// ref: Hassan1&2, Naglaa, and Norio Akamatsu. "A new approach for contrast enhancement using sigmoid function." (2004).
float sigmoid(float in_value, float contrast)
{
//    float out_value = in_value + in_value * contrast * (1.0 / (1.0 + exp(-in_value)));
